...
describe 'Condition dashboard' do
  describe '.average_number_of_rides_from_precip' do
    it 'calculates average number of trips given floor of precip chunk' do
      ...
      expect(Condition.average_number_of_rides_from_precipitation(0)).to eq(2)
    end
    ...
    it 'calculates average number of trips given floor of precip chunk greater than zero' do
      ...
      expect(Condition.average_number_of_rides_from_precipitation(0.5)).to eq(2)
    end

    it 'calculates average number of trips with multiple conditions' do
      condition_one = Condition.create(date: "01/01/2015", precipitation: 0.7)
      condition_two =  Condition.create(date: "01/02/2015", precipitation: 0.8)
      condition_one.trips.create(duration: 0, start_date: "01/01/2015", end_date: "01/01/2015", end_station_id: 0, bike_id: 0, zip_code: 0, station_id: 0, subscription_type_id: 0)
      condition_two.trips.create(duration: 0, start_date: "01/01/2015", end_date: "01/01/2015", end_station_id: 0, bike_id: 0, zip_code: 0, station_id: 0, subscription_type_id: 0)
      condition_two.trips.create(duration: 0, start_date: "01/01/2015", end_date: "01/01/2015", end_station_id: 0, bike_id: 0, zip_code: 0, station_id: 0, subscription_type_id: 0)


      expect(Condition.average_number_of_rides_from_precipitation(0.5)).to eq(1.5)
    end

    it 'assigns average numer of rides to zero when there are no trips in precip range' do
      
      expect(Condition.average_number_of_rides_from_precipitation(0)).to eq(0)
    end
    ...
    it 'calculates average number of trips only including those in precip range' do
      ...
      expect(Condition.average_number_of_rides_from_precipitation(0.5)).to eq(1)
    end
  end
  ...
  describe '.highest_number_of_rides_from_precip' do
    it 'calculates highest number of trips given floor of precip chunk' do
      ...
      expect(Condition.highest_number_of_rides_from_precipitation(0)).to eq(2)
    end
    ...
    it 'calculates highest number of trips given floor of precip chunk greater than zero' do
      ...
      expect(Condition.highest_number_of_rides_from_precipitation(0.5)).to eq(1)
    end

    it 'assigns highest number of rides to nil when there are no trips in precip range' do
      
      expect(Condition.highest_number_of_rides_from_precipitation(0)).to eq(nil)
    end
  ...
  describe '.lowest_number_of_rides_from_precip' do
    it 'calculates lowest number of trips given floor of precip chunk' do
      ...
      expect(Condition.lowest_number_of_rides_from_precipitation(0)).to eq(2)
    end
    ...
    it 'calculates lowest number of trips given floor of precip chunk greater than zero' do
      ...
      expect(Condition.lowest_number_of_rides_from_precipitation(0.5)).to eq(1)
    end
    ...
    it 'assigns lowest numer of rides to nil when there are no trips in precip range' do
      
      expect(Condition.lowest_number_of_rides_from_precipitation(0)).to eq(nil)
    end
