...
describe 'Condition dashboard' do
  describe '.average_number_of_rides_from_visibility' do
    ...
    it 'calculates average number of trips with multiple conditions' do
      ...
      expect(Condition.average_number_of_rides_from_visibility(8)).to eq(0.5)
    end
   ...
   describe '.highest_number_of_rides_from_visibility' do
    ...
    it 'calculates highest number of trips with multiple conditions' do
      ...
      expect(Condition.highest_number_of_rides_from_visibility(4)).to eq(0)
      expect(Condition.highest_number_of_rides_from_visibility(8)).to eq(1)
    end

    it 'assigns highest numer of rides to zero when there are no trips in visibility range' do
      
      expect(Condition.highest_number_of_rides_from_visibility(0)).to eq(0)
    end
  end
   ...
   describe '.lowest_number_of_rides_from_visibility' do
    ...
    it 'calculates lowest number of trips with multiple conditions' do
      ...
      expect(Condition.lowest_number_of_rides_from_visibility(4)).to eq(0)
      expect(Condition.lowest_number_of_rides_from_visibility(8)).to eq(0)
    end

    it 'assigns lowest numer of rides to zero when there are no trips in visibility range' do
      
      expect(Condition.lowest_number_of_rides_from_visibility(0)).to eq(0)
    end
  end
end