...
describe 'Condition dashboard' do
  describe '.average_number_of_rides_from_wind_speed' do
    ...
    it 'calculates average number of trips with multiple conditions' do
      ...
      expect(Condition.average_number_of_rides_from_wind_speed(8)).to eq(1)
    end
   ...
   describe '.highest_number_of_rides_from_wind_speed' do
    ...
    it 'calculates highest number of trips with multiple conditions' do
      ...
      expect(Condition.highest_number_of_rides_from_wind_speed(4)).to eq(nil)
      expect(Condition.highest_number_of_rides_from_wind_speed(8)).to eq(1)
    end

    it 'assigns highest numer of rides to nil when there are no trips in wind_speed range' do

      expect(Condition.highest_number_of_rides_from_wind_speed(0)).to eq(nil)
    end
  end
   ...
   describe '.lowest_number_of_rides_from_wind_speed' do
    ...
    it 'calculates lowest number of trips with multiple conditions' do
      ...
      expect(Condition.lowest_number_of_rides_from_wind_speed(4)).to eq(nil)
      expect(Condition.lowest_number_of_rides_from_wind_speed(8)).to eq(1)
    end

    it 'assigns lowest numer of rides to nil when there are no trips in wind_speed range' do

      expect(Condition.lowest_number_of_rides_from_wind_speed(0)).to eq(nil)
    end
  end
end
